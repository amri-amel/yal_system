...
@Component({
  selector: 'app-upload-course-cover',
  templateUrl: './upload-course-cover.component.html',
  styleUrls: ['./upload-course-cover.component.scss']
})
export class UploadCourseCoverComponent implements OnInit {
  ...
  startUpload(): void {
    const event: UploadInput = {
      type: 'uploadAll',
      url: `${environment.API_URL}/courses/cover/${this.courseId}`,
      method: 'PUT',
